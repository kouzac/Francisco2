...
int main()
{
    ...
    cout << "Los gundam posibles son, el gundam 00, nu gundam, star build srike gundam, RX-78-2 Gundam, Devil gundam, Altron Gundam \n";
    cout << "Wing zero gundam, gundam unit 4, gundam throne zwei, Mars gundam, gundam throne drei, astray red frame powered \n";
    cout << "gundam artemi, narrative gundam, God gundam, bolt gundam, gundam astray no name, Gadezza, Black Gundam Sefer Rasiel \n";
    cout << "Ground type Gundam, Gundam the end, Tequila Gundam, Portent Gundam, Crossbone gundam x2, Astrea Type F \n";
    cout << "Noir Astray Gundam \n";
    Sleep(1000);
                ...
                else
                {
                    ...
                    if (respuesta == 1) {
                        ...
                        if (respuesta == 1) {
                            ...
                            {
                                Sleep(1000);
                                cout << "Tu gundam es el Crossbone gundam x2" << std::endl;
                            }
                        }
                        else
                        {
